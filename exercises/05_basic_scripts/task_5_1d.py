...
params = ','.join(london_co[name_switch].keys())
name_parametr = str.lower(input('Введите имя параметра (' + params + '):'))

print(london_co[name_switch].get(name_parametr, "Такого параметра нет"))
